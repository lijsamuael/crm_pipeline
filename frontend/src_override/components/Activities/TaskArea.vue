      ...
      >
        <div class="flex flex-1 flex-col gap-1.5 text-base truncate">
          ...
          <div class="flex gap-1.5 text-ink-gray-8">
            ...
            <template v-if="task.custom_task_type || task.task_type">
              <div class="flex items-center justify-center">
                <DotIcon class="h-2.5 w-2.5 text-ink-gray-5" :radius="2" />
              </div>
              <div class="flex items-center gap-1 px-1.5 py-0.5 rounded bg-surface-gray-2 text-xs font-medium text-ink-gray-8 whitespace-nowrap">
                {{ task.custom_task_type || task.task_type }}
              </div>
            </template>
          </div>
        </div>
